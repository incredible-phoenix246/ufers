			...
			$(document).ready(function() {
			    $('#bs_table').DataTable( {
			        ...
			        buttons: [
			           /**/ {
							extend: 'csvHtml5',
							title: '<?php echo "GENERAL MALE CADETS FOR HOSTEL ALLOCATION";?>'
						},
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-8 col-lg-offset-2">
								<table pdata-order='[[ 3, "asc" ]]' data-page-length='25' class="table table-hover table-bordered" id="bs_table">
									<thead>
										<tr>
											<th style="text-align:center;">SNO</th><th>NPA NO.</th><th>RC</th><th>NAMES</th><th>STATE</th><th>RELIGION</th><th>STATUS</th>
										</tr>
									</thead>
									<tbody>								
										<?php
											//get the cadets
											$sno=1;
											$cdts=$mycon->prepare("SELECT cadet_bio.npa_no, cadet_bio.fname, cadet_bio.sname, cadet_bio.onames, cadet_rc.rc
												FROM cadet_bio
												JOIN cadet_rc
												ON cadet_bio.npa_no=cadet_rc.npa_no
												AND cadet_bio.gender=:male
												AND cadet_rc.rc !=:rc
												ORDER BY cadet_rc.rc ASC");
											$cdts->bindvalue(':male', 'M', PDO::PARAM_STR);
											$cdts->bindvalue(':rc', '6', PDO::PARAM_STR);
											$cdts->execute();
